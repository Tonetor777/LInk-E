          ...
          <div className="flex items-center justify-between w-[100%]">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-center justify-center space-x-4">
                ...
                <Link to = "/profile" className='flex items-center justify-center gap-2  px-3 py-2'>
                    <img src="" alt="" className='h-12 w-12 rounded-full' />
                    <label className='text-white mt-4 px-3 py-2'>Profile</label>
                </Link>

                <Link to="/logout">
                  <button className=" bg-blue-500 hover:bg-blue-700 text-gray-300 px-4 py-2 rounded-lg text-sm font-bold">Logout</button>
                </Link>
              </div>
            </div>
          </div>
